...
use ninja_protocol::community::{ConfigResponse, ExecuteMsg, InstantiateMsg, QueryMsg};
...
fn proper_initialization() {
    ...
    let msg = InstantiateMsg {
        ...
        ninja_token: "ninja0000".to_string(),
    ...
    assert_eq!("ninja0000", config.ninja_token.as_str());
...
fn test_spend() {
    ...
    assert_eq!(
        ...
        vec![SubMsg::new(CosmosMsg::Wasm(WasmMsg::Execute {
            contract_addr: "ninja0000".to_string(),
            funds: vec![],
