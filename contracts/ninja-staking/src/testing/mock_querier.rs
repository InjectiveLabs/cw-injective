...
use ninja_protocol::oracle::PriceResponse;
use ninja_protocol::short_reward::ShortRewardWeightResponse;
...
impl WasmMockQuerier {
    pub fn handle_query(&self, request: &QueryRequest<InjectiveQueryWrapper>) -> QuerierResult {
        match &request {
            QueryRequest::Custom(InjectiveQueryWrapper { route, query_data }) => {
