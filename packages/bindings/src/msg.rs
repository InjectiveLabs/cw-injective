...
pub fn create_market_volatility_update_msg(sender: Addr, previous: Decimal256, new: Decimal256) -> CosmosMsg<InjectiveMsgWrapper> {
    InjectiveMsgWrapper {
        route: InjectiveRoute::Exchange,
        msg_data: InjectiveMsg::MarketVolatilityUpdate {
            sender,
