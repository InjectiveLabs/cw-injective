...
pub fn calculate_spot_market_id(base_denom: String, quote_denom: String) -> Vec<u8> {
...
mod tests {
    ...
    fn test_new_spot_market_id() {
        ...
        let result = calculate_spot_market_id(base, quote);
        let expected_result = hex::decode("a508cb32923323679f29a032c70342c147c17d0145625922b0ef22e955c844c0").unwrap();
        assert_eq!(result, expected_result, "calculate_spot_market_id did not produce the expected hash");
    }
}
