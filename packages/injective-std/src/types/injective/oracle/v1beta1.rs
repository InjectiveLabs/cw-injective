...
#[derive(::serde::Serialize, ::serde::Deserialize, ::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/injective.oracle.v1beta1.GrantStorkPublisherPrivilegeProposal"
)]
...
#[derive(::serde::Serialize, ::serde::Deserialize, ::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/injective.oracle.v1beta1.RevokeStorkPublisherPrivilegeProposal"
)]
...
impl<'a, Q: cosmwasm_std::CustomQuery> OracleQuerier<'a, Q> {
    ...
    pub fn stork_publishers(
        &self,
    ) -> Result<QueryStorkPublishersResponse, cosmwasm_std::StdError> {
