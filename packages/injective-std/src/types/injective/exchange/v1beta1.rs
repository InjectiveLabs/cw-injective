...
#[derive(::serde::Serialize, ::serde::Deserialize, ::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/injective.exchange.v1beta1.MsgUpdateDerivativeMarketResponse"
)]
...
pub struct MsgBatchUpdateOrdersResponse {
    ...
    pub created_spot_orders_cids: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
    #[prost(string, repeated, tag = "8")]
    pub failed_spot_orders_cids: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
    #[prost(string, repeated, tag = "9")]
    pub created_derivative_orders_cids: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
    #[prost(string, repeated, tag = "10")]
    pub failed_derivative_orders_cids: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
    #[prost(string, repeated, tag = "11")]
    pub created_binary_options_orders_cids: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
    #[prost(string, repeated, tag = "12")]
    pub failed_binary_options_orders_cids: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
}
...
#[derive(::serde::Serialize, ::serde::Deserialize, ::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/injective.exchange.v1beta1.MsgEmergencySettleMarketResponse"
)]
...
#[derive(::serde::Serialize, ::serde::Deserialize, ::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/injective.exchange.v1beta1.MsgDecreasePositionMarginResponse"
)]
...
#[derive(::serde::Serialize, ::serde::Deserialize, ::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/injective.exchange.v1beta1.MsgAuthorizeStakeGrantsResponse"
)]
...
pub struct BatchExchangeModificationProposal {
    ...
    pub market_forced_settlement_proposals: ::prost::alloc::vec::Vec<
...
#[derive(::serde::Serialize, ::serde::Deserialize, ::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/injective.exchange.v1beta1.QueryAccountAddressSpotOrdersRequest"
)]
#[proto_query(
...
#[derive(::serde::Serialize, ::serde::Deserialize, ::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/injective.exchange.v1beta1.QueryAccountAddressSpotOrdersResponse"
)]
...
#[derive(::serde::Serialize, ::serde::Deserialize, ::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/injective.exchange.v1beta1.QueryGrantAuthorizationResponse"
)]
...
#[derive(::serde::Serialize, ::serde::Deserialize, ::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/injective.exchange.v1beta1.QueryGrantAuthorizationsRequest"
)]
#[proto_query(
...
#[derive(::serde::Serialize, ::serde::Deserialize, ::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/injective.exchange.v1beta1.QueryGrantAuthorizationsResponse"
)]
